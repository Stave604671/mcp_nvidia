...
async def main_test():
    ...
    res = await query_message(
        """
        你帮我查找到了以下题目，请你帮忙评估我的回答：
        我选择的题目是：
        在案例一中，乙帮助甲控制丙以索要欠款，但缺乏非法占有目的，乙的行为如何认定？
        这个题目的标准答案是：
        乙构成非法拘禁罪。其主观意图是帮助甲索要欠款，客观上实施了拘禁丙、剥夺其人身自由的行为，但缺乏非法占有目的，故不构成抢劫罪。
        我的回答是：
        构成非法拘禁罪。乙的行为是为了帮助甲索要欠款，虽然缺乏非法占有目的，但仍然剥夺了丙的人身自由，因此构成了非法拘禁罪。
        """
    )
